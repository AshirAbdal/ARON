    ...
    <>
      ...
      <div className="bg-black text-white text-xs py-2">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4 flex-wrap">
          ...
          <a href="mailto:arongbd@gmail.com" className="flex items-center gap-1 hover:text-gray-300">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            arongbd@gmail.com
          </a>
          <a href="tel:+8801700000000" className="flex items-center gap-1 hover:text-gray-300">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="px-4 py-3 space-y-2">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block py-2 text-sm font-medium text-gray-700 hover:text-black border-b border-gray-100 last:border-0"
                >
                  {link.label}
                </Link>
              ))}
