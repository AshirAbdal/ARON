    ...
    <div className="max-w-lg mx-auto px-4 py-20 text-center">
      ...
      {orderNumber && (
        <div className="bg-gray-50 border rounded-sm p-4 my-6">
          <p className="text-base text-gray-500 mb-1">Your Order ID</p>
          <p className="font-bold text-xl">{orderNumber}</p>
          <p className="text-base text-gray-400 mt-1">Save this to track your order</p>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        {orderNumber && (
          <Link
            ...
            className="border border-black px-8 py-3 text-base font-medium hover:bg-gray-50 transition-colors"
          >
            Track Order
          </Link>
        )}
